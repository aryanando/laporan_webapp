...
$(function () {
    $("#example1").DataTable({
        ...
        columns: [
            ...
            { width: "5%", targets: 3 },  // No.
            { width: "10%", targets: 4 }, // Tgl Registrasi
            { width: "15%", targets: 5 }, // Nama Pasien
            { width: "5%", targets: 6 },  // No.
            { width: "10%", targets: 7 }, // Tgl Registrasi
            { width: "15%", targets: 8 }, // Nama Pasien
            { width: "5%", targets: 9 },  // No.
        ]
    });
});
